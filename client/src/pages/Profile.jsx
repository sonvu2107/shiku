    ...
    <div key={`profile-${user._id}-${user.profileTheme}-${user.profileLayout}-${user.useCoverImage}`} className={`w-full min-h-screen ${layoutClass}`} style={{ backgroundColor: "#f8fafc" }}>
      ...
      <div className="relative -mt-8 md:-mt-20 px-4 md:px-6 pb-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden profile-card">
            {/* Profile Header */}
            <div className="pt-8 md:pt-6 p-4 md:p-6 profile-info">
              <div className="flex flex-col md:flex-row items-start md:items-end gap-3 md:gap-6">
          {/* Avatar */}
                <div className="relative -mt-6 md:-mt-20 z-10">
            ...
            {form.avatarUrl ? (
              ...
              />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Contact Info */}
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 contact-info">
                    ...
                    {user.showBirthday !== false && form.birthday && (
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span className="text-sm">{form.birthday}</span>
                  </div>
                )}
                    {user.showHobbies !== false && form.hobbies && (
                      <div className="flex items-center gap-2 text-gray-600">
                        <Heart className="w-4 h-4" />
                        <span className="text-sm">{form.hobbies}</span>
                  </div>
                )}
              </div>
                </div>
