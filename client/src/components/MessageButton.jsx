...
export default function MessageButton({ user, className = "" }) {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={`inline-flex items-center px-4 py-2 bg-black dark:bg-white text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${className}`}
    >
