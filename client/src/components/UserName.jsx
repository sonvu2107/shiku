 ...
 */
export default function UserName({ user, className = "", maxLength = 20, showTooltip = true, isMobile = false }) {
	...
	return (
		<span 
			className={`inline-flex items-center gap-1 ${isMobile ? 'user-name-truncate-mobile' : 'user-name-truncate'} ${className}`}
