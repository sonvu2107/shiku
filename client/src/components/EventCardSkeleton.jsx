...
export default function EventCardSkeleton() {
  return (
    ...
    border border-transparent dark:border-white/5">
      ...
      <div className="h-48 sm:h-56 md:h-64 lg:h-72 w-full bg-gray-200 dark:bg-gray-800 animate-pulse"></div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              <div className="h-6 bg-gray-200 dark:bg-gray-800 rounded animate-pulse w-48"></div>
              <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded-full animate-pulse w-16"></div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <div className="h-10 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse w-full sm:w-32"></div>
            <div className="h-10 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse w-full sm:w-24"></div>
          </div>
        </div>
      </div>
    </div>
